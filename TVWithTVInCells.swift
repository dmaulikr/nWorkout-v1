...
class TVWithTVInCellDataSource<Delegate: DataSourceDelegate, DataProv: DataProvider, Cell: UITableViewCell>: NSObject, UITableViewDataSource where Delegate.Object == DataProv.Object, Cell: ConfigurableCell, Cell.DataSource == DataProv.Object {
    ...
    func processUpdates(updates: [DataProviderUpdate]?) {
        ...
        for update in updates {
            ...
            case .update(let indexPath, let object):
                ...
                cell.configureForObject(object: object as! DataProv.Object, at: indexPath)
